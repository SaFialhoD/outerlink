...
impl OuterLinkError {
    ...
    ///
    /// Transport, connection, and IO errors are retryable.
    /// CUDA errors, protocol errors, and config errors are not — they represent
    /// definitive outcomes that won't change on retry.
