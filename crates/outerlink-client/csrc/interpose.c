...
static const hook_entry_t hook_table[] = {
    ...
    { "cuMemsetD16",             (void *)hook_cuMemsetD16 },
    { "cuMemsetD16_v2",         (void *)hook_cuMemsetD16 },
    { "cuMemsetD8Async",         (void *)hook_cuMemsetD8Async },
    { "cuMemsetD32Async",        (void *)hook_cuMemsetD32Async },
    { "cuMemsetD16Async",        (void *)hook_cuMemsetD16Async },
    { "cuMemcpy",                (void *)hook_cuMemcpy },
    ...
    { "nvmlInit",                              (void *)nvml_hook_nvmlInit },
    { "nvmlInit_v2",                           (void *)nvml_hook_nvmlInit_v2 },
    { "nvmlInitWithFlags",                     (void *)nvml_hook_nvmlInitWithFlags },
    { "nvmlShutdown",                          (void *)nvml_hook_nvmlShutdown },
    { "nvmlSystemGetDriverVersion",            (void *)nvml_hook_nvmlSystemGetDriverVersion },
    { "nvmlSystemGetNVMLVersion",              (void *)nvml_hook_nvmlSystemGetNVMLVersion },
    { "nvmlSystemGetCudaDriverVersion",        (void *)nvml_hook_nvmlSystemGetCudaDriverVersion },
    { "nvmlSystemGetCudaDriverVersion_v2",     (void *)nvml_hook_nvmlSystemGetCudaDriverVersion_v2 },
    { "nvmlDeviceGetCount",                    (void *)nvml_hook_nvmlDeviceGetCount },
    { "nvmlDeviceGetCount_v2",                 (void *)nvml_hook_nvmlDeviceGetCount_v2 },
    { "nvmlDeviceGetHandleByIndex",            (void *)nvml_hook_nvmlDeviceGetHandleByIndex },
    { "nvmlDeviceGetHandleByIndex_v2",         (void *)nvml_hook_nvmlDeviceGetHandleByIndex_v2 },
    { "nvmlDeviceGetHandleByUUID",             (void *)nvml_hook_nvmlDeviceGetHandleByUUID },
    { "nvmlDeviceGetName",                     (void *)nvml_hook_nvmlDeviceGetName },
    { "nvmlDeviceGetUUID",                     (void *)nvml_hook_nvmlDeviceGetUUID },
    { "nvmlDeviceGetMemoryInfo",               (void *)nvml_hook_nvmlDeviceGetMemoryInfo },
    { "nvmlDeviceGetMemoryInfo_v2",            (void *)nvml_hook_nvmlDeviceGetMemoryInfo_v2 },
    { "nvmlDeviceGetUtilizationRates",         (void *)nvml_hook_nvmlDeviceGetUtilizationRates },
    { "nvmlDeviceGetTemperature",              (void *)nvml_hook_nvmlDeviceGetTemperature },
    { "nvmlDeviceGetPowerUsage",               (void *)nvml_hook_nvmlDeviceGetPowerUsage },
    { "nvmlDeviceGetPowerManagementLimit",     (void *)nvml_hook_nvmlDeviceGetPowerManagementLimit },
    { "nvmlDeviceGetFanSpeed",                 (void *)nvml_hook_nvmlDeviceGetFanSpeed },
    { "nvmlDeviceGetFanSpeed_v2",              (void *)nvml_hook_nvmlDeviceGetFanSpeed_v2 },
    { "nvmlDeviceGetClockInfo",                (void *)nvml_hook_nvmlDeviceGetClockInfo },
    { "nvmlDeviceGetPciInfo",                  (void *)nvml_hook_nvmlDeviceGetPciInfo },
    { "nvmlDeviceGetPciInfo_v3",               (void *)nvml_hook_nvmlDeviceGetPciInfo_v3 },
    { "nvmlDeviceGetCudaComputeCapability",    (void *)nvml_hook_nvmlDeviceGetCudaComputeCapability },
    { "nvmlDeviceGetIndex",                    (void *)nvml_hook_nvmlDeviceGetIndex },
    { "nvmlDeviceGetNumGpuCores",              (void *)nvml_hook_nvmlDeviceGetNumGpuCores },
    { "nvmlDeviceGetArchitecture",             (void *)nvml_hook_nvmlDeviceGetArchitecture },
    { "nvmlDeviceGetComputeRunningProcesses_v3", (void *)nvml_hook_nvmlDeviceGetComputeRunningProcesses_v3 },
    { "nvmlErrorString",                       (void *)nvml_hook_nvmlErrorString },
...
CUresult hook_cuMemsetD16(CUdeviceptr dstDevice, unsigned short value, size_t count) {
    ensure_init();
    return ol_cuMemsetD16((unsigned long long)dstDevice, value, count);
}

CUresult hook_cuMemsetD16Async(CUdeviceptr dstDevice, unsigned short value, size_t count, CUstream hStream) {
    ensure_init();
    return ol_cuMemsetD16Async((unsigned long long)dstDevice, value, count,
                                (unsigned long long)(uintptr_t)hStream);
}

CUresult hook_cuMemcpy(CUdeviceptr dst, CUdeviceptr src, size_t ByteCount) {
    ensure_init();
    return ol_cuMemcpy((unsigned long long)dst, (unsigned long long)src, ByteCount);
}
